...
<script type="text/javascript">
		...
		function query(type){
			...
			$('#tab').datagrid({
				...
				columns:[[
					...
					{field:'total1',title:'总人数',width:100}
				]]
			});
			
			$.ajax({
				  type: 'POST',
				  url: 'chart/rechargeCount',
				  data: param,
				  dataType:'json',
				  async: false,
		...
		function expExcel(){
			window.location.href="export/rechargeCount?minDate=" + param.minDate + "&maxDate=" + param.maxDate;
		}
	</script>
</head>
