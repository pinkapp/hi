...
<script type="text/javascript">
		...
		function chart() {
			...
			var chart = new FusionCharts("Charts/Line.swf", "ChartId", "100%", "100%", "0", "0");
		   	chart.setXMLData(XMLData);
		    chart.render("chartdiv");
		}
		function expExcel(){
			window.location.href="export/regCount?minDate=" + param.minDate + "&maxDate=" + param.maxDate;
		}
	</script>
</head>
