...
<script type="text/javascript">
		...
		function expExcel(){
			window.location.href=encodeURI(encodeURI("export/energyLog?type=" + param.type + "&player=" + param.player + "&minTime=" + param.minTime + "&maxTime=" + param.maxTime));
		}
	</script>
</head>
