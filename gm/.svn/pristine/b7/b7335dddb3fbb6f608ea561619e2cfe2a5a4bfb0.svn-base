...
<script type="text/javascript">
		...
		function expExcel(){
			window.location.href="export/rechargeRank2?maxDate=" + param.maxDate + "&minDate=" + param.minDate;
		}
	</script>
</head>
