...
<script type="text/javascript">
		...
		function expExcel(){
			window.location.href=encodeURI(encodeURI("export/featLog?type=" + param.type + "&player=" + param.player + "&minTime=" + param.minTime + "&maxTime=" + param.maxTime));
		}
	</script>
</head>
