...
<body>
	<div id="title">
		<label>基本管理&gt;&gt;封IP</label>
	</div>
	<div id="thisform">
		<fieldset>
			<legend>永久</legend>
			<form action="do/closeIP?type=1" method="post" id="type1">
				<table class="ftable">
					<tr>
					...
					<tr>
						<td align="right" valign="top"><label for="reason">封IP原因：</label></td>
		...
		<fieldset>
			<legend>指定时间</legend>
			<form action="do/closeIP?type=2" method="post" id="type2">
				<table class="ftable">
					<tr>
						<td align="right"><label for="player">&nbsp;&nbsp;&nbsp;玩家：</label></td>
						<td><input id="player" name="player"
