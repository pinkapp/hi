...
/**
 * 
 * base on java.io.DataOutputStream
 * 
 * @author Administrator
 * 
 */
public class CPPOutputStream extends FilterOutputStream implements DataOutput {
	 ...
	 * <p>
	 * The <code>flush</code> method of <code>CPPOutputStream</code> calls the
	 ...
	 * @exception IOException
	 *                if an I/O error occurs.
	 * @see java.io.CPPOutputStream#writeChar(int)
	 * @see java.io.FilterOutputStream#out
	 */
	...
	static int writeUTF(String str, DataOutput out) throws IOException {
		...
		byte[] bytearr = null;
		if (out instanceof CPPOutputStream) {
			CPPOutputStream dos = (CPPOutputStream) out;
	 ...
	 * @see java.io.CPPOutputStream#written
	 */
