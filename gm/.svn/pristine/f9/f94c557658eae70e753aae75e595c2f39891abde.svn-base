...
<script type="text/javascript">
		...
		function query(){
			...
			$('#tab').datagrid({
				...
				columns:[[
					...
					{field:'giftbagType',title:'礼包类型',width:10,sortable:true},
					{field:'gifts',title:'礼品',width:25,sortable:true},
		...
		function expExcel(){
			window.location.href=encodeURI(encodeURI("export/giftbagLog?type=" + param.type + "&player=" + param.player + "&minTime=" + param.minTime + "&maxTime=" + param.maxTime));
		}
	</script>
</head>
