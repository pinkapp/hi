/*
 * @(#)CPPInputStream.java	1.77 06/06/07
 *
 ...
 * stream.
 * <p>
 * CPPInputStream is not necessarily safe for multithreaded access. Thread
 * safety is optional and is the responsibility of users of methods in this
 * class.
 * 
 * @author huangdecai (低端转高端)
 * @version 1.78, 12/11/06
 * @see base on java.io.DataOutputStream
 * @since JDK1.0
 */
public class CPPInputStream extends FilterInputStream implements DataInput {

	/**
	 * Creates a CPPInputStream that uses the specified underlying InputStream.
	 * 
	 * @param in
	...
	/**
	 * update 2012-11-07 读取从低端到高端 See the general contract of the
	 * <code>readShort</code> method of <code>DataInput</code>.
	 * <p>
	 * Bytes for this operation are read from the contained input stream.
	 * 
	...
	/**
	 * update 2012-11-07 读取从低端到高端 See the general contract of the
	 * <code>readUnsignedShort</code> method of <code>DataInput</code>.
	 * <p>
	 * Bytes for this operation are read from the contained input stream.
	 * 
	...
	/**
	 * update 2012-11-07 读取从低端到高端 See the general contract of the
	 * <code>readChar</code> method of <code>DataInput</code>.
	 * <p>
	 * Bytes for this operation are read from the contained input stream.
	 * 
	...
	/**
	 * update 2012-11-06 读取从低端到高端 See the general contract of the
	 * <code>readInt</code> method of <code>DataInput</code>.
	 * <p>
	 * Bytes for this operation are read from the contained input stream.
	 * 
	...
	/**
	 * update 2012-11-07 读取从低端到高端 See the general contract of the
	 * <code>readLong</code> method of <code>DataInput</code>.
	 * <p>
	 * Bytes for this operation are read from the contained input stream.
	 * 
	...
	public final long readLong() throws IOException {
		...
		return (((long) readBuffer[0] << 56)
				+ ((long) (readBuffer[1] & 255) << 0)
				+ ((long) (readBuffer[2] & 255) << 8)
				+ ((long) (readBuffer[3] & 255) << 16)
				+ ((long) (readBuffer[4] & 255) << 24)
				+ ((readBuffer[5] & 255) << 32) + ((readBuffer[6] & 255) << 40) + ((readBuffer[7] & 255) << 48));
	}
	 ...
	 *                does not support reading after close, or another I/O error
	 *                occurs.
	 * @see java.io.CPPInputStream#readInt()
	 ...
	 *                does not support reading after close, or another I/O error
	 *                occurs.
	 * @see java.io.CPPInputStream#readLong()
	 ...
	 *             Programs that use the <code>CPPInputStream</code> class to
	 *             read lines can be converted to use the
	 *             <code>BufferedReader</code> class by replacing code of the
	 *             form: <blockquote>
	 * 
	 *             <pre>
	 * CPPInputStream d = new CPPInputStream(in);
	 * </pre>
	 * 
	 ...
	 * @see java.io.CPPInputStream#readUTF(java.io.DataInput)
	 */
	 ...
	 * @see java.io.CPPInputStream#readUnsignedShort()
	 */
	public final static String readUTF(DataInput in) throws IOException {
		int utflen = in.readUnsignedShort();
		byte[] bytearr = null;
		char[] chararr = null;
		if (in instanceof CPPInputStream) {
			CPPInputStream dis = (CPPInputStream) in;
