...
public class Client extends PHPFunctions
{
	...
	public static String UC_KEY = "default_key";
	...
	{
		Client c = new Client();
		String string = "4795Gb%2FzA54o2INA36gE16s%2BmrJ%2Bzs78AeOHzhNLRHxozkFg0ZqR4Q5ot3G%2F%2Fo8YBp9%2Fh2FLri7pnLRZVZhi";
		try
		{
		...
		String aa = c.uc_authcode(string, "DECODE");
			...
			boolean $block)
	{
		...
		try
		{
			...
			} else
			{
				...
				if ($return != null)
				{
					$return = $return.replace("localhost", $ip);
				}
				$fp.close();
			}
		} catch (IOException e)
	...
	public String uc_user_register(String $username, String $password,
			String $email, String $questionid, String $answer)
	{
