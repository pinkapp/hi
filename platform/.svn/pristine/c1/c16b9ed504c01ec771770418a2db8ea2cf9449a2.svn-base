...
<html>
  ...
  <body>
    <div class="title1">平台统计 &gt;&gt; 单个用户充值总额数统计</div>
    ...
    <table>
	    ...
	    <s:a namespace="/admin" action="user_chargeTotalUserCount_export">导出数据</s:a>
		    <table class="datatable" width="100%">
			   ...
			   <s:iterator value="chargeTotalUserCounts">
			   <tr>
			     <td>${chargeTotal }</td>
			     <td>${usercount }</td>
			     <td>${percent }</td>
