...
<html>
  ...
  <body>
    <div class="title1">平台统计 &gt;&gt; 每日充值总额统计</div>
    <s:form namespace="/admin" action="user_dailyChargeMoneyCount">
    ...
    <div>
    <s:a namespace="/admin" action="user_dailyChargeMoneyCount_export"><s:param name="month">${month }</s:param>导出数据</s:a>
    <table class="datatable" width="100%">
   <tr>
    <th scope="col">日期</th>
    <th scope="col">充值总额</th>
   </tr>
   <s:iterator value="dailyChargeMoneyCounts">
   <tr>
     <td>${chargetime }</td>
     <td>${moneycount }</td>
   </tr>
