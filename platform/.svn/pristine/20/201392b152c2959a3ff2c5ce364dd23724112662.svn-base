...
<html>
  ...
  <body>
    <div class="title1">平台统计 &gt;&gt; 每日登录次数统计</div>
    <s:form namespace="/admin" action="user_dailyUserloginCount">
    ...
    <div>
    <s:a namespace="/admin" action="user_dailyUserloginCount_export"><s:param name="month">${month }</s:param>导出数据</s:a>
    <table class="datatable" width="100%">
   <tr>
    <th scope="col">登录日期</th>
    <th scope="col">登录次数</th>
   </tr>
   <s:iterator value="dailyUserloginCounts">
   <tr>
     <td>${logintime }</td>
     <td>${logincount }</td>
   </tr>
