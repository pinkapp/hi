...
public class ClassMethodUtil {
	...
	private static Map<String, Map<String, Method>> getMethodMapByClass(
			Class<?> clazz) {
	...
	private final static String setPrefix = "set"; /* getter prefix */
