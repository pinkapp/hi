...
<html>
  ...
  <body>
    <div class="title1">平台统计 &gt;&gt; 总注册用户统计</div>
    <s:form namespace="/admin" action="user_dailyRegisterTotalCount">
    ...
    <div>
    <s:a namespace="/admin" action="user_dailyRegisterTotalCount_export"><s:param name="month">${month }</s:param>导出数据</s:a>
    <table class="datatable" width="100%">
   <tr>
    <th scope="col">日期</th>
    <th scope="col">用户总数</th>
   </tr>
   <s:iterator value="dailyRegisterTotalCounts">
   <tr>
     <td>${time }</td>
     <td>${registerTotalcount }</td>
   </tr>
   </s:iterator>
