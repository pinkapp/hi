...
<html>
  ...
  <body>
    <div class="title1">平台统计 &gt;&gt; 每日注册人数统计</div>
    <s:form namespace="/admin" action="user_dailyNewUserCount">
    ...
    <div>
    <s:a namespace="/admin" action="user_dailyNewUserCount_export"><s:param name="month">${month }</s:param>导出数据</s:a>
    <table class="datatable" width="100%">
   <tr>
    <th scope="col">注册日期</th>
    <th scope="col">注册用户数</th>
   </tr>
   <s:iterator value="dailyNewUserCounts">
   <tr>
     <td>${registertime }</td>
     <td>${registercount }</td>
   </tr>
