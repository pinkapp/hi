...
<html>
  ...
  <body>
    <div class="title1">平台统计 &gt;&gt; 用户年龄段统计</div>
    <div style="padding: 10px;">
    <div id="chartdiv">正在加载...</div>
    <div>
    <s:a namespace="/admin" action="user_agegroupCount_export">导出数据</s:a>
    <table class="datatable" width="100%">
   <tr>
    <th scope="col">年龄段</th>
    <th scope="col">用户数</th>
   </tr>
   <s:iterator value="userAgegroupCounts">
   <tr>
     <td width="50%">${agegroup }</td>
     <td>${usercount }</td>
   </tr>
   </s:iterator>
