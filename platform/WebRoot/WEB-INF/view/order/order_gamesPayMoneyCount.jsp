...
<html>
  ...
  <body>
    <div class="title1">平台统计 &gt;&gt; 游戏消费总额统计</div>
    <s:form namespace="/admin" action="order_gamesPayMoneyCount">
    ...
    <div>
    <s:a namespace="/admin" action="order_gamesPayMoneyCount_export"><s:param name="month">${month }</s:param>导出数据</s:a>
    <table class="datatable" width="100%">
   <tr>
    <th scope="col">日期</th>
    <th scope="col">盛世三国</th>
    <th scope="col">神仙道</th>
    <th scope="col">天地英雄</th>
    <th scope="col">总额</th>
   </tr>
   <s:iterator value="gamesPayMoneyCounts">
   <tr>
     <td>${time }</td>
     <td>${game1paymoney }</td>
     <td>${game2paymoney }</td>
