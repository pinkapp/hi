 ...
 * 小写转大写
 * 
 * @author lily200825 2011-5-16 <li>最大支持<font color='red'>仟万亿</font>(16位整数,2位小数)
 *         </li>
 */
public class RMB
{
	...
	/**
	 * 小写金额 转 大写金额 <li>最大支持<font color='red'>百万亿</font>(15位整数，2位小数) ；或<font
	 * color='red'>仟万亿</font>(16位整数)</li> <li>超过最大支持<font
	 * color='red'>仟万亿</font>(16位整数)，只输出大写数字</li> <li>整数部分越大，则小数部分输出越不精确</li>
	 * <li>负数，则忽略负号</li>
	 * 
	 * @param amount
	 * @return 大写金额
